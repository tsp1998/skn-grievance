	...
	<div class="container">
			...
			<div class="col-sm-10">
				...
				<div class="info">
					...
					<ul>
						...
						<li>Suggestion / complaint Box is installed in front of the Administrative Block in which the Students, who want to remain anonymous, put in writing their grievances and their suggestions for improving the Academics / Administration in the College. </li>
						...
						<li>Advising All the Students to refrain from inciting Students against other Students, teachers and College administration </li>
						<li>Advising all staffs to be affectionate to the Students and not behave in a vindictive manner towards any of them for any reason.</li>
						<li>Ragging in any form is strictly prohibited in and outside the institution. Any violation of ragging and disciplinary rules should be urgently brought to the notice of the Principal. </li>
		...
		<div class="row">
			...
			<div class="col-sm-10">
				...
				<div class="info">
					<ul>
						<li>The students may feel free to put up a grievance in writing/or in the format available in the admin dept. and drop it in boxes </li>
						<li>The Grievance Cell will act upon those cases which have been forwarded along with the necessary documents. </li>
						<li>The Grievance Cell will assure that the grievance has been properly solved in a stipulated time limit provided by the cell.</li>
					</ul>
